...
/*-----------------------------------------------------------------
1)  Make—or promote—the chosen account into a SELLER
    ( $EMAIL is substituted by sqlite3's `.parameter` feature )
------------------------------------------------------------------*/
UPDATE USERS
   SET Role = 'SELLER'
 WHERE Email = $EMAIL;
...
/*-----------------------------------------------------------------
2)  Insert eight demo PRODUCTS owned by that seller
------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------
3)  One SKU per product (match on Name + SellerID)
------------------------------------------------------------------*/
